...
win32 {
    #Nasty hack:
    #ya,do it manually for static lib

    DEFINES +=QUAZIP_STATIC
    LIBS += -LE:\Personnel\Document\autoPackager\QtLibraries\zlib-1.2.11-win32 -llibz
    INCLUDEPATH += E:\Personnel\Document\autoPackager\QtLibraries\zlib-1.2.11-win32
